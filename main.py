...
# he will undo his and bot move but then bot will do next move on player turn etc.
# just make player wait for bot to make his move - add (if not bot move) then undo ig
